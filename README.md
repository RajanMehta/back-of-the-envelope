...
A Streamlit web app for quick back-of-the-envelope estimations during system design interviews. Type informal math expressions like `30 billion * 500 bytes` and instantly see human-friendly results like `15 TB`.

Built for speed during live interviews — enter estimates line by line, and copy the full summary when you're done.
